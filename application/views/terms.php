    ...
    <div class="container">
      <div class="row mb-5 align-items-end">
        <div class="col-md-6" data-aos="fade-up">
          <h1>Condition and terms</h1>
          <p>Last updated: February 02, 2020</p>
          <hr class="divider">
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 mb-12 mb-md-0" data-aos="fade-up">
          ...
          <ul>
              ...
              <li>
                  <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to hydrogencode.</p>
                    </li>
                <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
              <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
            <li><strong>Website</strong> refers to hydrogencode, accessible from www.hydrogencode.it</li>        <li><strong>Service</strong> refers to the Website.</li>
          ...
          <ul>
                  <li>By email: info@hydrogencode.it</li>
                  </ul>
        </div>
      </div>
